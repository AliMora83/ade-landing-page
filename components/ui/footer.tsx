        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <li>
                <Link
                  href="https://twitter.com/adeoba_mercies?t=-eAeGZ5-IEJ1j2zsTWYOsw&s=09"
                  target="_blank"
              ...
              <li className="ml-4">
                <Link
                  href="https://www.facebook.com/merciesOluwa?mibextid=ZbWKwL"
                  target="_blank"
                  className="flex justify-center items-center text-purple-100 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out"
                  aria-label="Facebook"
                >
              ...
              <li className="ml-4">
                <Link
                  href="https://instagram.com/crown.jesu?igshid=ZGUzMzM3NWJiOQ=="
                  target="_blank"
                  className="flex justify-center items-center text-purple-100 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out"
              ...
              <li className="ml-4">
                <Link
                  href="https://www.linkedin.com/in/adeobajesu-aboluwade-764527127"
                  target="_blank"
                  className="flex justify-center items-center text-purple-100 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out"
                  aria-label="Linkedin"
                >
